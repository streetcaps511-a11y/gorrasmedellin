...
// ============================================
// DASHBOARD BÁSICO (para todos los usuarios)
// ============================================
// Todos los usuarios autenticados pueden ver su dashboard básico
router.get('/', dashboardController.getDashboardBasico);
router.get('/perfil', dashboardController.getPerfilInfo);

// ============================================
// DASHBOARD DE CLIENTE (específico para clientes)
// ============================================
router.get('/cliente', dashboardController.getDashboardCliente);
router.get('/cliente/compras', dashboardController.getMisCompras);
router.get('/cliente/facturas', dashboardController.getMisFacturas);
